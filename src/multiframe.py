"""Legacy center-based multi-frame aggregation.

Features:
- Analyze independent generated NMA samples
...
This module is retained for compatibility and is not used by the canonical or
experimental Phase 4 pipeline. New motion evidence lives in motion_ensemble.py.
"""
