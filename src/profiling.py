...
from src.resources import ProcessMemorySnapshot, get_process_memory_snapshot
...
class PipelineProfiler:
    ...
    def __init__(self):
        ...
        self._memory_start: ProcessMemorySnapshot | None = None

    def start_pipeline(self):
        self._pipeline_start = time.perf_counter()
        self._memory_start = get_process_memory_snapshot()
    ...
    def summary(self) -> dict[str, Any]:
        ...
        return {
            ...
            "start_rss_bytes": (
                self._memory_start.current_rss_bytes if self._memory_start is not None else None
            ),
    ...
    def format_table(self) -> str:
        ...
        lines.append(f"Peak process RSS: {s['peak_rss_bytes'] / 1024**2:.1f} MiB")
        return "\n".join(lines)
