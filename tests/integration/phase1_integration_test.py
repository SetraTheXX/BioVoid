...
# Proje dizinleri (tests/integration/ -> project root)
...
def calculate_nma(ca_atoms):
    ...
    print("   ⚙️ Eigendecomposition yapılıyor...")
        ...
        try:
            ...
            for vertex_idx, vertex in enumerate(vor.vertices):
                ...
                if 2.5 <= min_dist <= 8.0:
                    ...
                    valid_voids.append({"position": vertex, "radius": min_dist, "volume": volume})
...
def visualize_results(coords, all_voids):
    ...
    try:
        ...
        for i, coord in enumerate(coords):
            pymol.cmd.pseudoatom("protein", pos=coord.tolist(), name=f"CA{i}")
