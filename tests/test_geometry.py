...
TEST_PDB = PROJECT_ROOT / "data" / "raw_pdb" / "1cbs.pdb"

pytestmark = [
    pytest.mark.scientific,
    pytest.mark.skipif(
        not TEST_PDB.exists(),
        reason="Real PDB fixture is not included in the public source-only repository",
    ),
]
...
def test_heavy_atoms_extraction():
    ...
    print("   ✅ Heavy atoms extraction successful")
    print("   ✅ NaN/Inf check passed")
    print("   ✅ Bounding box valid")
...
def test_ca_only_extraction():
    ...
    print("   ✅ CA-only extraction successful")
...
def test_voronoi_calculation():
    ...
    print("   ✅ Voronoi calculation successful")
...
def test_convexhull_filtering():
    ...
    print("   ✅ ConvexHull filtering successful")
    print("   ✅ Ghost voids eliminated!")
...
def test_void_properties():
    ...
    print("   ✅ Void properties calculated correctly")
...
def test_performance():
    ...
    start = time.time()
    find_voids(pdb_path, atom_type="ca")
    ...
    start = time.time()
    find_voids(pdb_path, atom_type="heavy")
