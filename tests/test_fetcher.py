...
from src.fetcher import FetchError, fetch_pdb, get_ca_atoms, get_structure
...
def test_basic_functionality():
    ...
    try:
        ...
        print("  ✅ File in correct directory")
...
def test_performance():
    ...
    if cache_time < 0.1:
        print("  ✅ Cache performance excellent (< 0.1s)")
    else:
